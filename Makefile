...
.container-$(DOTFILE_IMAGE): build-linux_amd64 Dockerfile
	@sed                                 \
	    -e 's|{ARG_BIN}|$(BIN)|g'        \
	    Dockerfile.in > .dockerfile-linux_amd64
	@docker build -t $(IMAGE):$(TAG) -f .dockerfile-linux_amd64 .
